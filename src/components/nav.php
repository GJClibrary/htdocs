...
<div id="mySidebar" class="sidebar">
  ...
  <a href="<?php echo "$src/about.php"; ?>">About</a>
  <a href="<?php echo "$src/team.php"; ?>">Team</a>
  <a href="#">Services</a>
  <a href="#">Clients</a>
  <a href="#">Contact</a>
</div>
...
<nav class="navbar navbar-light bg-light">
    <div class="d-flex justify-content-between w-100">
            <div class="d-flex align-items-center">
                ...
                <img src="public/images/gjc_logo.png" alt="GJC Logo" class="logo-image mr-1" style="width: 34px;">
                <a class="navbar-brand" href="<?php echo "http://$host/GJCLIBRARY"; ?>">GJC</a>
            </div>
       ...
       <?php if(isset($_SESSION['user_id'])): ?>
            ...
            <!-- Login button -->
            <div>
                <button class="btn btn-primary mr-2 mt-2" onclick="window.location.href='<?php echo "http://$host$uri/signin.php"; ?>'">Login</button>
            </div>
            <?php endif; ?>
    </div>
